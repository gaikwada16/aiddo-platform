...
-- AddForeignKey
ALTER TABLE "LedgerEntry" ADD CONSTRAINT "LedgerEntry_reversedBy_fkey" FOREIGN KEY ("reversedBy") REFERENCES "LedgerEntry"("id") ON DELETE SET NULL ON UPDATE CASCADE;
